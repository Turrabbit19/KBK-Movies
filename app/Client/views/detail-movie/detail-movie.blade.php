...
<!-- Mirrored from pixner.net/boleto/demo/movie-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 11:20:03 GMT -->
...
<body>
    ...
    <!-- ==========Banner-Section========== -->
    <section class="details-banner bg_img" data-background="{{ BASE_URL_IMG . $detailMovie->poster }}">
        <div class="container">
            <div class="details-banner-wrapper">
                <div class="details-banner-thumb">
                    <img src="{{ BASE_URL_IMG . $detailMovie->avatar }}" alt="movie">
                    <a href="{{ BASE_URL_IMG . $detailMovie->trailer_url }}" class="video-popup">
                        <img src="{{ BASE_URL . 'public/client/images/movie/video-button.png' }}" alt="movie">
                    </a>
                </div>
                <div class="details-banner-content offset-lg-3">
                    <h3 class="title">{{ $detailMovie->name }}</h3>
                    <div class="tags">
                        @foreach ($languageMovie as $item)
                            <a href="#0">{{ $item->nameLanguage }}</a>
                        @endforeach
                    </div>
                    @foreach ($genreMovie as $item)
                        <a href="#0" class="button">{{ $item->nameGenre }}</a>
                    @endforeach
                    <div class="social-and-duration">
                        <div class="duration-area">
                            <div class="item">
                                <i
                                    class="fas fa-calendar-alt"></i><span>{{ (new DateTime($detailMovie->release_date))->format('d/m/Y') }}</span>
                            </div>
                            <div class="item">
                                <i class="far fa-clock"></i><span>{{ $detailMovie->duration }}</span>
                            </div>
                        </div>
                ...
                <div class="left-side">
                    <div class="item">
                        <div class="item-header">
                            <div class="thumb">
                                <img src="{{ BASE_URL . 'public/client/images/movie/tomato2.png' }}" alt="movie">
                            </div>
                    ...
                    <div class="item">
                        <div class="item-header">
                            <div class="thumb">
                                <img src="{{ BASE_URL . 'public/client/images/movie/cake2.png' }}" alt="movie">
                            </div>
                            <div class="counter-area">
                                <span class="counter-item odometer" data-odometer-final="88">0</span>
                            </div>
                ...
                <div class="col-lg-9 mb-50">
                    <div class="movie-details">
                        ...
                        <div class="details-photos owl-carousel">
                            @foreach ($photoMovie as $item)
                                <div class="thumb">
                                    <a href="{{ BASE_URL_IMG . $item->image }}" class="img-pop">
                                ...
                                <div class="tab-item active">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="casting-slider owl-carousel">
                                            @foreach ($castMovie as $item)
                                                <div class="cast-item">
                                                    <div class="cast-thumb">
                                                        <a href="#0">
                                                            <img src="{{ BASE_URL_IMG . $item->imageCast }}"
                                                               height="110" alt="cast">
                                                        </a>
                                                    </div>
                                                    <div class="cast-content">
                                                        <h6 class="cast-title"><a href="#0">{{$item->nameCast}}</a></h6>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="casting-slider-two owl-carousel">
                                           ...
                                           <div class="cast-item">
                                            <div class="cast-thumb">
                                                <a href="#0">
                                                    <img src="{{ BASE_URL_IMG . $item->imageCast }}" height="110" alt="cast">
                                                </a>
                                            </div>
                                            <div class="cast-content">
                                                <h6 class="cast-title"><a href="#0">{{$item->nameCast}}</a></h6>
        ...
        <div class="newslater-section padding-bottom">
            <div class="container">
                <div class="newslater-container bg_img"
                    data-background="{{ BASE_URL . 'public/client/images/newslater/newslater-bg01.jpg' }}">
...
<!-- Mirrored from pixner.net/boleto/demo/movie-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 11:20:09 GMT -->
