...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    ...
    <a href="{{route("admin/add-genre")}}" class="btn btn-primary btn-icon-split">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route("admin/detail-genre/" . $gens->id)}}" class="btn btn-warning">
                                <span class="icon text-white-50">
                        ...
                        <td>
                            <a href="{{route("admin/del-genre/" . $gens->id)}}" class="btn btn-danger"
