...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route("admin/edit-seat-type/" . $seatTypes->id) }}" method="POST" class="m-3">
            ...
            <a href="{{route("admin/list-seat-type")}}"><button type="button" class="btn btn-info">Danh sách</button></a>
        </form>
    </div>
</div>
