...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <a href="{{route("admin/add-coupon")}}" class="btn btn-primary btn-icon-split">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($coupons as $index => $cous)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("admin/detail-coupon/" . $cous->id)}}" class="btn btn-warning">
                                        <span class="icon text-white-50">
                                ...
                                <td>
                                    <a href="{{route("admin/del-coupon/" . $cous->id)}}" class="btn btn-danger"
