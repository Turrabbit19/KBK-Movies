            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route("admin/appear-review/" . $review->rw_id)}}" class="btn btn-primary btn-icon-split">
                        ...
                        <td>
                            <a href="{{route("admin/hidden-review/" . $review->rw_id)}}" class="btn btn-secondary btn-icon-split"
