...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route("admin/edit-showtime/" . $detailST->id) }}" method="POST" class="m-3">
            ...
            <div class="form-group">
                ...
                <input type="time" class="form-control" id="show_time" name="show_time" value="{{$detailST->show_time}}">
            </div>
            <br>
            <input class="btn btn-outline-warning mr-2" type="submit" name="edit" value="SỬA">

            <a href="{{route("admin/list-showtime")}}"><button type="button" class="btn btn-info">Danh sách</button></a>
        </form>
    </div>
</div>
