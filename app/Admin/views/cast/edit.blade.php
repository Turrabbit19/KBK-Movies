...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route("admin/edit-cast/" . $cast->id) }}" method="POST" class="m-3" enctype="multipart/form-data">
            ...
            <a href="{{route("admin/list-cast")}}"><button type="button" class="btn btn-info">Danh sách</button></a>
        </form>
    </div>
</div>
