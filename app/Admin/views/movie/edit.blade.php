...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route("admin/edit-movie/" .$movie->id) }}" method="POST" class="m-3" enctype="multipart/form-data">
                ...
                <a href="{{route("admin/list-movie")}}"><button type="button" class="btn btn-info">Danh sách</button></a>
            </form>
        </div>
    </div>
