...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <a href="{{route("admin/add-movie")}}" class="btn btn-primary btn-icon-split">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($movies as $index => $movs)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("admin/detail-movie/" . $movs->id)}}" class="btn btn-warning">
                                <span class="icon text-white-50">
                                ...
                                <td>
                                    <a href="{{route("admin/del-movie/" . $movs->id)}}" class="btn btn-danger"
